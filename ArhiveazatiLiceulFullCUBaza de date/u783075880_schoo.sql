...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 13, 2019 at 06:43 PM
...
(1, 'Stanciu', 'directiunea', 'Stefan', 'Matematica', 'XI-B-REAL', 'danstanciu50@yahoo.com', 'aasdsd', 'staff/profil.png', '0769933863');
...
('Collège Spiru-Haret', 'Bobalna', 'Prahova', 'Ploiesti', '0244-512161', 5);
...
(20, 'ECDL', '4', '18-11-2003', 'Examen', 'XI', 'Mathématiques');
...
(52, 'Claire', 'qwerty', 'Mathématiques', '0769873424', 'doctor95p@gmail.com', 'Pays Roumanie, comté de Prahova, commune de Verniceni, 123 rue, n °. 123\r\n', 'staff/images.jpg', 'XI-B-Réal', 'Sofia');
...
(12, 'S101', 'Valentin', 'Pete', '15-11-2001', 'Male', '0983424523', 'danstanciu50@yahoo.com', 'Pays Roumanie, comté de Prahova, commune de Barcanesti, Strada 125, Nr.34\r\n', 'XI', 'B', 'student/download.jpg', 52, 'Réal');
...
--
ALTER TABLE `profilul`
  MODIFY `TPROF` int(150) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
