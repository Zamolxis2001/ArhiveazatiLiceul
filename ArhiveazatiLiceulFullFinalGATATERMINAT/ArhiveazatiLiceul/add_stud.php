		...
		<?php include"navbar.php";?><br>
			...
			<div id="section">
				...
				<div class="lbox">
					...
					<input type="text" class="input3" name="name"  pattern="[^()/><\][\\\x22,;|]+"><br><br>
					<label>Numele tatălui</label><br>
					<input type="text" class="input3" name="fname"  pattern="[^()/><\][\\\x22,;|]+"><br><br>
					...
					<input type="number" class="input3" maxlength="10" name="pho"><br><br>
				</div>
				
				<div class="rbox">
				
				<label> E-mail părinte</label><br>
					<input type="email" class="input3" name="email" pattern="[^()/><\][\\\x22,;|]+"><br><br>
					
					<label>  Adresă</label><br>
					<input required class="input" name="addr"pattern="[^()/><\][\\\x22;|]+"><br><br>
