			...
			<div id="section">
				...
				<div class="content">
					...
					<form  enctype="multipart/form-data" role="form"  method="post" action="<?php echo $_SERVER["PHP_SELF"];?>">
							...
							<input type="number" maxlength="10" required class="input3" name="pno" ><br><br>
							<label> Adresă e-mail</label><br>
							<input type="email"  class="input3" required name="mail"  pattern="[^()/><\][\\\x22,;|]+"><br><br>
							<label> Adresă</label><br>
							<input type="text" required class="input3" name="addr"  pattern="[^()/><\][\\\x22;|]+"></textarea><br><br>
